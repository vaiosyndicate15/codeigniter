...
class Crudkelmangunsari extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/mangunsari/datamangunsari',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/mangunsari/tambahdatakel',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/mangunsari/crudkelmangunsari/index');	
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/mangunsari/editdatakel',$data);
	}
