...
class Crudkkmangunsari extends CI_Controller{

	function __construct()
	{
		parent::__construct();
		if (($this->session->userdata('username')=="") && ($this->session->userdata('username')!='adminmangunsari'))
		{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/mangunsari/datakkmangunsari',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/mangunsari/tambahdatakk',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/mangunsari/crudkkmangunsari/tambah');	
	}
	...
	function hapus($nokk)
	{
		...
		redirect('index.php/puskesmas/mangunsari/crudkkmangunsari/index');
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/mangunsari/editdatakk',$data);
	}
	...
	function detail($id)
	{
		...
		$this->load->view('viewpuskesmas/mangunsari/detailkkmangunsari',$data);
	}
