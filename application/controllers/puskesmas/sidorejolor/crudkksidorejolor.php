...
class Crudkksidorejolor extends CI_Controller{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/sidorejolor/datakksidorejolor',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/sidorejolor/tambahdatakk',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/sidorejolor/crudkksidorejolor/tambah');	
	}
	...
	function hapus($nokk)
	{
		...
		redirect('index.php/puskesmas/sidorejolor/crudkksidorejolor/index');
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/sidorejolor/editdatakk',$data);
	}
	...
	function detail($id)
	{
		...
		$this->load->view('viewpuskesmas/sidorejolor/detailkksidorejolor',$data);
	}
