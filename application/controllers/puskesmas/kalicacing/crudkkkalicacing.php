...
class Crudkkkalicacing extends CI_Controller{

	function __construct()
	{
		parent::__construct();
		if (($this->session->userdata('username')=="") && ($this->session->userdata('username')!='adminkalicacing'))
		{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/kalicacing/datakkkalicacing',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/kalicacing/tambahdatakk',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/kalicacing/crudkkkalicacing/tambah');	
	}
	...
	function hapus($nokk)
	{
		...
		redirect('index.php/puskesmas/kalicacing/crudkkkalicacing/index');
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/kalicacing/editdatakk',$data);
	}
	...
	function detail($id)
	{
		...
		$this->load->view('viewpuskesmas/kalicacing/detailkkkalicacing',$data);
	}
