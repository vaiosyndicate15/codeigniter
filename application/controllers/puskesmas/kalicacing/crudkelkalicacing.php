...
class Crudkelkalicacing extends CI_Controller 
{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/kalicacing/datakalicacing',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/kalicacing/tambahdatakel',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/kalicacing/crudkelkalicacing/index');	
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/kalicacing/editdatakel',$data);
	}
