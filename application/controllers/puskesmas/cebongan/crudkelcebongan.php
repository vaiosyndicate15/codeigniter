...
class Crudkelcebongan extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/cebongan/datacebongan',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/cebongan/tambahdatakel',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/cebongan/crudkelcebongan/index');	
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/cebongan/editdatakel',$data);
	}
