...
class Crudkkcebongan extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/cebongan/datakkcebongan',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/cebongan/tambahdatakk',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/cebongan/crudkkcebongan/tambah');	
	}
	...
	function hapus($nokk)
	{
		...
		helper_log("delete", "hapus data");
		$this->session->set_flashdata('category_hapus', 'Berhasil Hapus Data.');
		redirect('index.php/puskesmas/cebongan/crudkkcebongan/index');
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/cebongan/editdatakk',$data);
	}
	...
	function detail($id)
	{
		...
		$this->load->view('viewpuskesmas/cebongan/detailkkcebongan',$data);
	}
