...
class Crudkksidorejokidul extends CI_Controller{

	function __construct()
	{
		parent::__construct();
		if (($this->session->userdata('username')=="") && ($this->session->userdata('username')!='adminsidorejokidul'))
		{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/sidorejokidul/datakksidorejokidul',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/sidorejokidul/tambahdatakk',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/sidorejokidul/crudkksidorejokidul/tambah');	
	}
	...
	function hapus($nokk)
	{
		...
		redirect('index.php/puskesmas/sidorejokidul/crudkksidorejokidul/index');
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/sidorejokidul/editdatakk',$data);
	}
	...
	function detail($id)
	{
		...
		$this->load->view('viewpuskesmas/sidorejokidul/detailkksidorejokidul',$data);
	}
