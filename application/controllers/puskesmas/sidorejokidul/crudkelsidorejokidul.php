...
class Crudkelsidorejokidul extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/sidorejokidul/datasidorejokidul',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/sidorejokidul/tambahdatakel',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/sidorejokidul/crudkelsidorejokidul/index');	
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/sidorejokidul/editdatakel',$data);
	}
