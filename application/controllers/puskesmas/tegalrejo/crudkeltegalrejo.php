...
class Crudkeltegalrejo extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('viewpuskesmas/tegalrejo/datategalrejo',$data);
	}

	function tambah()
	{
		$data['username'] = $this->session->userdata('username');
		$this->load->view('viewpuskesmas/tegalrejo/tambahdatakel',$data);
	}
	...
	function tambah_aksi()
	{
		...
		redirect('index.php/puskesmas/tegalrejo/crudkeltegalrejo/index');	
	}
	...
	function edit($id)
	{
		...
		$this->load->view('viewpuskesmas/tegalrejo/editdatakel',$data);
	}
