              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <?php foreach($datawilayah as $u){ ?>
                    <form name="kalkulasi" class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/puskesmas/kalicacing/crudkelkalicacing/update'; ?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="pilihwil" class="select2_single form-control" tabindex="-1">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="air" id="air" value="<?php echo $u->air;?>" onFocus="startCalc();" onBlur="stopCalc();" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control col-md-7 col-xs-12" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
