                    ...
                    <tbody>
                      ...
                      foreach ($kk as $u)
                      {
                        ...
                        <tr>
                          ...
                          <td><a href="<?=base_url()?>index.php/puskesmas/kalicacing/crudkkkalicacing/detail/<?=$u->id?>" onclick="window.open(this.href,&quot;popupwindow&quot;,&quot;status=0, height=500, width=900, scrollbars=yes, resizable=0, top=0, left=0&quot;); return false;" target="_blank" class="btn btn-info btn-sm" style="text-decoration:none;">Detail Status PHBS</a></td>
                          <td>
                              <?php echo anchor('index.php/puskesmas/kalicacing/crudkkkalicacing/edit/'.$u->id,'Edit'); ?>
                              <?php echo anchor('index.php/puskesmas/kalicacing/crudkkkalicacing/hapus/'.$u->nokk,'Hapus'); ?>
                          </td>  
                        </tr>
                        <?php
                      }
