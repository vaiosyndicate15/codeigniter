        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Data Kelurahan Sidorejo Kidul</h2>
                    ...
                    <tbody>
                      ...
                      foreach ($datawilayah as $u)
                      {
                        ...
                        <tr>
                          ...
                          <td><?php echo $u->persen16 ?></td>
                          <td>
                                <?php echo anchor('index.php/puskesmas/sidorejokidul/crudkelsidorejokidul/edit/'.$u->id,'Edit'); ?>
                                <?php echo anchor('index.php/puskesmas/sidorejokidul/crudkelsidorejokidul//hapus/'.$u->id,'Hapus'); ?>
                          </td>
                        </tr>
                        <?php
                      }
