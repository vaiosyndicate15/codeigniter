              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form name="kalkulasi" class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/puskesmas/sidorejokidul/crudkelsidorejokidul/tambah_aksi'; ?>" method="POST">
