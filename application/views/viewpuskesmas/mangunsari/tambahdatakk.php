                ...
                <div class="x_panel">
                 <div class="x_title">
                  ...
                  <div class="x_content">
                    ...
                    <form name="kalkulasi" class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/puskesmas/mangunsari/crudkkmangunsari/tambah_aksi'; ?>" method="POST">
