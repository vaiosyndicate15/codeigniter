              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <?php if ($this->session->flashdata('category_success')) { ?>
                    <h2>Tambah Data <small><?= $this->session->flashdata('category_success') ?></small></h2>                    
                  <?php } ?>
                  ...
                  <div class="x_content">                 
                    ...
                    <form name="kalkulasi" class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/puskesmas/cebongan/crudkkcebongan/tambah_aksi'; ?>" method="POST">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nokk" class="form-control col-md-7 col-xs-12" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="namakk" class="form-control col-md-7 col-xs-12"  required="required">
                        </div>
                      </div>
                      <div class="item form-group">
