                ...
                <h3>Form Validation</h3>
                 <div class="x_title">
                  ...
                  <div class="x_content">
                    ...
                    <form name="kalkulasi" class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/puskesmas/tegalrejo/crudkktegalrejo/tambah_aksi'; ?>" method="POST">
