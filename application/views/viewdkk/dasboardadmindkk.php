...
<html lang="en">
  <head>
    ...
    <title>Dashboard Admin DKK </title>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <?php foreach ($tot as $u){?>
              <div class="count"><?php echo $u->jumlahadmin;?></div>
              <span class="count_bottom"><i class="green"></i> Admin Puskesmas</span>
              <?php }?>              
            </div>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="temperature"><b>Selamat datang <?php echo $username;?> di panel admin DKK. Silahkan pilih menu disamping untuk melakukan pengolahan data</b>
                          </div>
                        </div>
                      </div>                      
                    </div>
                    ...
                    <div class="x_content">
                      ...
                      <div class="">
                        <ul class="to_do">
                          <li>
                            <p>
                              <input type="checkbox" class="flat" name="listing[]"  value="<?php echo $u->cat_isi; ?>" <?php echo in_array($u->cat_isi, $data) ? 'checked' : ''; ?>> <?php echo $u->cat_isi;?></p>
                          </li>
                        </ul>
                        <?php } ?>
                      </div>
                      ...
                      <li>
                        <div class="block">
                          <div class="block_content">
                            ...
                            <div class="byline">
                              <span><?php echo $u->waktu;?></span> by <a><?php echo $u->nama;?></a> email <a><?php echo $u->email;?></a>
                            </div>
                            <p class="excerpt"><?php echo $u->pesan;?>
                            </p>
                          </div>
                        </div>
                      </li>                     
