          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit ID+Password <small>sub title</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/dkk/c_kontak/update'; ?>" method="POST">
                      <span class="section">Personal Info</span>
                      <input type="hidden" name="id" class="form-control col-md-7 col-xs-12" data-validate-length-range="20" value="<?php echo $u->pus_id;?>">
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nama Lengkap <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nama" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" placeholder="e.g Kian Santang" value="<?php echo $u->pus_namalengkap;?>" required="required">
                        </div>
                      </div>
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="telp" class="form-control col-md-7 col-xs-12" data-validate-length-range="12" value="<?php echo $u->pus_notelp;?>" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" name="email" required="required" value="<?php echo $u->pus_email;?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="username">Password Baru<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="pw" class="form-control col-md-7 col-xs-12" required="required">
                        </div>
                      </div>                
