...
<html lang="en">
  <head>
    ...
    <script src="<?php echo base_url("public/js/fungsi-strata.js")?>"></script>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form name="hitung" class="form-horizontal form-label-left" action="<?php echo base_url(). 'index.php/dkk/crud_strata/tambah_aksi'; ?>" method="POST">
                    <?php if($this->session->flashdata('info')== TRUE):?>
                      <span class="section"<?php echo $this->session->flashdata('category_success');?></span>
                    <?php endif;?>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="sample" class="form-control col-md-7 col-xs-12" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="a" id="sehatpratama" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="b" id="sehatmadya" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="c" id="sehatutama" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control col-md-7 col-xs-12" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="d" id="sehatparipurna" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control col-md-7 col-xs-12" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
